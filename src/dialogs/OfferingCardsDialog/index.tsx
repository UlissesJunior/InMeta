...
interface OfferingCardsDialogProps {
  userCards: ICard[];
  ...
  receivingCardIds: string[];
}

const OfferingCardsDialog: React.FC<OfferingCardsDialogProps> = ({
  userCards,
  selectedCardIds,
  isOpen,
  onClose,
  ...
  const filteredCards = userCards.filter(card => !receivingCardIds.includes(card.id));
    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-0 flex justify-center items-center">
        <div className="bg-white p-8 rounded-lg shadow-lg overflow-y-auto max-w-xl w-full h-1/2">
          <h1 className="mb-6 text-gray-800 font-medium text-xl">Cartas que deseja oferecer</h1>
...
export default OfferingCardsDialog;